...
class Person:
    def __init__(self):
        ...
        # person's attributes
        self.name = random_account["name"]
        self.follower_count = random_account["follower_count"]
        self.description = random_account["description"]
        self.country = random_account["country"]

    def print_full(self):
        # print all attributes for 1st person
        print(f"Name: {self.name}\nDescription: {self.description}\nCountry: {self.country}\nFollowers: {self.follower_count} million")
...
def game():
    ...
    points = 0
    print(logo)
    input("Welcome to higher or lower. Try to guess who has more IG followers.\nPress ENTER to begin: ")
    ...
    try_again = input(f"Game over. You scored {points} points.\n\nStart over?\nYes/No: ").lower()
...
def matchup():
    ...
    if higher_lower_guess == answer:
        ...
        print(f"\nSorry! {person2.name} has {person2.follower_count} million followers.")
        return 0
